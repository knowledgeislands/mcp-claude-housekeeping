 ...
 *
 * Every `cleaner_*` tool (write/destructive) is logged by default. Reads can be
 * included by setting MCP_CLAUDE_HOUSEKEEPING_AUDIT_LOG_ALL=1. Path is
 * configurable via MCP_CLAUDE_HOUSEKEEPING_AUDIT_LOG_PATH; defaults to
